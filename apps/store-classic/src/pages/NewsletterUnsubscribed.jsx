// D:\WebProjects\Calestra\apps\store-classic\src\pages\NewsletterUnsubscribed.jsx
    ...
    <div style={{ padding: "32px 16px", maxWidth: 720, margin: "0 auto" }}>
      ...
      >
        ...
        <p style={{ margin: 0, opacity: 0.9, fontWeight: 800 }}>
          Du är nu avregistrerad från Calestra-utskick.
        </p>
        ...
        <p style={{ marginTop: 14, fontSize: 12, opacity: 0.7, fontWeight: 800 }}>
          Ångrar du dig? Prenumerera igen via formuläret när som helst.
        </p>
      </div>
    </div>
  );
