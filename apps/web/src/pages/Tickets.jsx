  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <p className="small opacity-80 mt-1">
        Välj dagsbiljett eller paket. Lanseringsfas: kassan öppnas snart â€“ förhandsboka via Store.
      </p>

      <div className="grid" style={{ gridTemplateColumns:"repeat(3,1fr)", gap:12, marginTop:14 }}>
        <div className="card"><div className="card-pad">
          <div className="h3">Dagspass</div>
          <p className="small opacity-80">EntrÃ© till alla öppna zoner en valfri dag.</p>
        ...
        <div className="card"><div className="card-pad">
          ...
          <p className="small opacity-80">Fri entrÃ© hela året + medlemsförmåner.</p>
