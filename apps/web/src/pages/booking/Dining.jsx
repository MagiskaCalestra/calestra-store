...
const RESTAURANTS = [
  {
    ...
    hours: { breakfast: "08:00–10:30", lunch: "11:30–15:30", dinner: "17:00–21:00" }
  },
  {
    id: "rs",
    name: "River’s Song",
    ...
    hours: { lunch: "12:00–15:00", dinner: "17:30–22:00" }
  },
  {
    id: "sm",
    ...
    hours: { allDay: "10:00–22:00" }
  }
];

/** enkel slotsimulator – byt till riktig availability i backend */
...
export default function Dining() {
  ...
  return (
    <div className="container py-10">
      ...
      <p className="muted">Filtrera, hitta en plats som matchar din känsla – och se lediga tider.</p>
            ...
            <article key={r.id} className="product">
              <div className="row wrap" style={{gap:16}}>
                ...
                <div style={{flex:1, minWidth:240}}>
                  ...
                  <p className="muted">
                    {r.area} • {r.type.join(" · ")} • {"$".repeat(r.price)}
                  </p>
                  <p style={{marginTop:6}} className="muted">
                    {r.hours.breakfast && <>Frukost {r.hours.breakfast} · </>}
                    {r.hours.lunch && <>Lunch {r.hours.lunch} · </>}
                ...
                <div className="row" style={{gap:10}}>
                  ...
                  <button className="btn ghost" onClick={()=>alert("Visa meny – kopplas mot meny-API")}>
                    Visa meny
                  </button>
                </div>
              </div>
