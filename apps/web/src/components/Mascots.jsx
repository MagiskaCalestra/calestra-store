  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <h2 style={{margin:"6px 0 10px", fontWeight:900}}>Hybridrävarna â€” syster & bror</h2>
        <p className="lead">
        ...
        <div className="card" style={{marginTop:12}}>
          <img src={mascots} alt="De två hybridrävarna â€” flicka och pojke â€” vid en kvällsbelyst stig" />
        </div>
      </div>
    </section>
  );
